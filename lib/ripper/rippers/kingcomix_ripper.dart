...
class KingcomixRipper extends AbstractHTMLRipper {
  KingcomixRipper(super.url);

  static final RegExp _gidPattern =
      RegExp(r'^https://kingcomix\.com/([a-zA-Z1-9_-]*)/?$');

  @override
  String getHost() => 'kingcomix';

  String getDomain() => 'kingcomix.com';
  ...
  static List<String> imageUrlsFromDocument(Document page) {
    return [
      for (final image in page.querySelectorAll('div.entry-content > p > img'))
