...
class ShesFreakyRipper extends AbstractHTMLRipper {
  static final RegExp _gidPattern = RegExp(
    r'^https?://[wm.]*shesfreaky\.com/gallery/([a-zA-Z0-9\-_]+).*$',
  );

  ShesFreakyRipper(super.url);

  @override
  String getHost() => 'shesfreaky';

  String getDomain() => 'shesfreaky.com';
  ...
  Future<String> getGID(Uri url) async {
    ...
    throw FormatException(
      'Expected shesfreaky.com URL format: '
  ...
  static List<String> imageUrlsFromDocument(Document page) {
    return [
      for (final thumb in page.querySelectorAll('a[data-lightbox="gallery"]'))
        'https:${thumb.attributes['href'] ?? ''}',
    ];
  }
