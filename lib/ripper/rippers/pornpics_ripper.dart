...
class PornpicsRipper extends AbstractHTMLRipper {
  static final RegExp _gidPattern = RegExp(
    r'^https?://www\.pornpics\.com/galleries/([a-zA-Z0-9_-]*)/?$',
  );

  PornpicsRipper(super.url);

  @override
  String getHost() => 'pornpics';

  String getDomain() => 'pornpics.com';
  ...
  static List<String> imageUrlsFromDocument(Document page) {
    return [
      for (final link in page.querySelectorAll('a.rel-link'))
