...
class MyreadingmangaRipper extends AbstractHTMLRipper {
  static final RegExp _gidPattern = RegExp(
    r'^https://myreadingmanga\.info/([a-zA-Z_\-0-9]+)/?$',
  );

  MyreadingmangaRipper(super.url);

  @override
  String getHost() => 'myreadingmanga';

  String getDomain() => 'myreadingmanga.info';
  ...
  Future<String> getGID(Uri url) async {
    ...
    throw FormatException(
      'Expected myreadingmanga.info URL format: '
  ...
  static List<String> imageUrlsFromDocument(Document page) {
    return [
      for (final image in page.querySelectorAll('div * img[data-lazy-src]'))
