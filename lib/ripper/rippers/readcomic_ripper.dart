...
class ReadcomicRipper extends AbstractHTMLRipper {
  static final RegExp _gidPattern = RegExp(
    r'^https?://read-comic\.com/([a-zA-Z1-9_-]*)/?$',
  );

  ReadcomicRipper(super.url);

  @override
  String getHost() => 'read-comic';

  String getDomain() => 'read-comic.com';
  ...
  static List<String> imageUrlsFromDocument(Document page) {
    return [
      for (final image in page.querySelectorAll('div.pinbin-copy > a > img'))
